      ...
      <div class="main-content container-fluid">
        <div class="splash-container">
          <div class="card card-border-color card-border-color-primary">
            <div class="card-header"><img class="logo-img" src="assets/img/1bcb7e8893204665b86670bad53fd246-removebg-preview.png" alt="logo" width="102" height="80"><span class="splash-description">Departmental Heads Login Panel.</span></div>
            <div class="card-body">
