      ...
      <div class="main-content container-fluid">
        <div class="splash-container">
          <div class="card card-border-color card-border-color-primary">
            <div class="card-header"><img class="logo-img" src="assets/img/1bcb7e8893204665b86670bad53fd246-removebg-preview.png" alt="logo" width="70" height="70"><span class="splash-description">Pharmacy Department Login Panel</span></div>
            <div class="card-body">
